<template>
  <div>
    <div class="mx-auto max-w-7xl py-24 sm:px-6 lg:px-8 not-prose">
      <div
          class="relative isolate overflow-hidden bg-gray-900 px-6 shadow-2xl sm:rounded-3xl sm:px-16 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
