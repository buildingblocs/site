<template>
    <div class="text-center text-gray-500 dark:text-gray-400">
        <img class="mx-auto mb-4 w-36 h-36 rounded-full" src="/teams/ppl/wenkai.jpg">
        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
            <p>Liu Wenkai</p>
        </h3>
        <p class="pt-2">Hi, I'm Wenkai, a JC1 student from NUSH.</p>
        <ul class="flex justify-center mt-3 space-x-4 mb-3">
            <li>
                <NuxtLink href="https://github.com/squi-ddy"
            ...
            <li>
                <NuxtLink href="https://squiddy.me/"
                    class="text-gray-900 hover:text-gray-900 dark:hover:text-white dark:text-gray-300">
