<template>
    <div class="sticky top-0 z-10">
        <header class="absolute inset-x-0 top-0">
            <nav class="bg-white dark:bg-slate-800 backdrop-filter backdrop-blur-xl bg-opacity-50 dark:bg-opacity-50 border-b border-gray-100 dark:border-slate-800 flex items-center justify-between py-4 px-6 xl:py-3 xl:px-8"
                aria-label="Global">
                ...
                <div class="flex xl:hidden">
                    <Menu as="div" class="relative inline-block text-left mt-1">
                        ...
                        <transition enter-active-class="transition duration-100 ease-out"
                            ...
                            <MenuItems
                                class="absolute right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 dark:divide-gray-700 rounded-md bg-white dark:bg-slate-800 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                                <div class="px-1 py-1">
                                    <MenuItem v-for="item in navigation" :key="item.name" :href="item.href">
